...
/**
 * Esta clase representa las casillas
 * que formaran la superficie.
 * Contiene atributos privados para
 * indicar la posicion da cada casilla
 * en la matriz superficie.
...
public class Casilla {
	...
	/**
	 * Crea una casilla nueva a partir
